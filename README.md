...
Components communicate over a mitt-based client-side event bus — publishers announce facts like "note renamed" or "theme changed," consumers decide what to refresh. 20 topics cover note lifecycle, sidebar, menu, and edit sessions, plus themes, plugins, and search. See [docs/event-bus.md](docs/event-bus.md) for the topic registry and usage guide.
